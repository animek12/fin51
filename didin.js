...
didin.send5ButImg(i, txt, `DidinBotz‡`, log0, btn, thum)
}
...
if (!isCreator) return replay(mess.owner)
            ...
            didin.sendMessage(yoi, { caption: `${melo}`, location: { jpegThumbnail: await reSize(buffer, 200, 200) }, buttons: button, footer: `DidinBotz‡`, mentions: [m.sender] })
		}		
            }
            break
            case 'q': case 'quoted': {
...
case 'store':{
  ...
  const listMessage = {
   text: `*_Welcome To DidinBotz Store_*`,
   footer: "DidinBotz‡",
   title: "",
...
didin.sendMessage(m.chat, { react: { text: "🌹", key: m.key }})
  	anu = `*sᴀʏᴀ ᴅɪᴅɪɴʙᴏᴛ, ʙᴏᴛ ᴡʜᴀᴛsᴀᴘᴘ ʏᴀɴɢ ᴍᴇᴍʙᴀɴᴛᴜ ᴀɴᴅᴀ ᴜɴᴛᴜᴋ ᴍᴇᴍᴘᴇʀᴍᴜᴅᴀʜ sᴇsᴜᴀᴛᴜ sᴇᴘᴇʀᴛɪ ᴍᴇᴍʙᴜᴀᴛ sᴛɪᴄᴋᴇʀ ᴅᴀɴ ʟᴀɪɴɴʏᴀ.*`
